    ...
    <section className="relative px-6 py-24 overflow-hidden bg-gradient-to-tr from-gray-900 via-gray-600 to-gray-300 text-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-gray-100 bg-clip-text text-transparent drop-shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="px-8 py-4 border-2 border-white/70 text-white rounded-lg hover:bg-white/10 backdrop-blur-sm transition-all">
              <span className="text-lg font-semibold">
                Dowiedz się więcej
              </span>
            </button>
